...
<template>
  <header class="p-3 headeur-style text-white">
    ...
    <div class="container">
      <div class="">
        <div class="d-flex flex-wrap align-item-center justify-content-center">
  ...
  <path d="M2 4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.172a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 9.172 2H6.828a2 2 0 0 0-1.414.586l-.828.828A2 2 0 0 1 3.172 4H2zm.5 2a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm9 2.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0z"/>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" class="form-control" value="alex@mail.com">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="password" class="form-control" value="(320) 380-4539">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="button" class="btn btn-style px-4" value="Save Changes">
                    </div>
                </div>
            </div>
        </div>
